...
export const modalProductDesc = modalProduct.querySelector(
  ".modal-product__description"
);
export const modalProductPrice = modalProduct.querySelector(
  ".modal-product__price-count"
);
export const modalProductBtn = modalProduct.querySelector(
  ".modal-product__btn"
);
